...
- (void)viewDidLoad {
    ...
    [backendless.data mapTableToClass:@"Restaurant" type:PlaceToEat.class];
...
-(void)fetchingFirstPage {
    ...
    @try {
        ...
        BackendlessCollection *restaurants = [[backendless.persistenceService of:PlaceToEat.class] find:query];
        ...
        for (PlaceToEat *restuarant in currentPage) {
...
-(void)fetchingFirstPageAsync {
    ...
    BackendlessDataQuery *query = [BackendlessDataQuery query];
    query.queryOptions = queryOptions;
    [[backendless.persistenceService of:PlaceToEat.class]
     find:query
